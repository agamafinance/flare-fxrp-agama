...
[4.2.0]: https://github.com/PaulRBerg/prb-math/compare/v4.1.2...v4.2.0
[4.1.2]: https://github.com/PaulRBerg/prb-math/compare/v4.1.1...v4.1.2
...
- Add `sign` function to `SD59x18` ([#285](https://github.com/PaulRBerg/prb-math/pull/285)) (@Amxx, @pcaversaccio)
...
- Check `y == 0` before `abs(x)` in `SD59x18.powu` so that `MIN_SD59x18 ** 0` returns `UNIT` instead of reverting
  ([#279](https://github.com/PaulRBerg/prb-math/pull/279)) (@BhariGowda)
- Correct inline comment for the `remainder` expression in `UD60x18.floor` ([#277](https://github.com/PaulRBerg/prb-math/pull/277)) (@ikwuoz)
